window.onload = function () {
  ...
  function renderHabit(habitDiv, name, waterLvl) {
    ...
    if (waterLvl <= 4) {
      svg = `<svg class="center" width="128" height="128" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `;
      ...
      svg = `<svg class="center" width="128" height="128" viewBox="0 0 64 64">
      <rect x="28" y="32" width="8" height="28" fill="sienna"/>
      <circle cx="32" cy="24" r="16" fill="forestgreen"/>
      <circle cx="20" cy="28" r="12" fill="forestgreen"/>
      <circle cx="44" cy="28" r="12" fill="forestgreen"/>
    ...
    habitDiv.innerHTML = `
      ${svg}
      <button class="center" onclick="addWater(this)">
          Add water to habit: ${name}
          <svg class="center" width="32" height="32" viewBox="0 0 32 32">
